...
<div class="m-4 w-[calc(100%-2rem)] self-center lg:(m-7 max-w-2xl) md:m-6 sm:(m-5 max-w-xl w-auto) xl:m-8 2xl:max-w-4xl xl:max-w-3xl [&>article]:(lg:text-3.75 xl:text-base)">
